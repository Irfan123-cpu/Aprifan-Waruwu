...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('destinations.create') }}" class="btn btn-primary d-inline-flex align-items-center gap-2">
    ...
    <table class="table table-striped table-hover border mt-3">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group" role="group">
                            ...
                            <a href="{{ route('destinations.show', $d->id) }}" class="btn btn-info btn-sm text-white">View</a>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center">Data destinasi tidak ditemukan.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
